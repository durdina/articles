--------------------------------------------------------
--  File created - Piatok-máj-30-2014   
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "TST_PRACVZTAH" 
   (	"OSOBA_TOP_CODE" VARCHAR2(20), 
	...
	"VALID_FROM" DATE, 
	"VALID_TO" DATE, 
	"OSOBA_TOP_PRACKAT_CODE" VARCHAR2(20), 
	"OSOBA_SUB_PRACKAT_CODE" VARCHAR2(20)
   )
/
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into TST_PRACVZTAH (OSOBA_TOP_CODE,OSOBA_SUB_CODE,VALID_FROM,VALID_TO,OSOBA_TOP_PRACKAT_CODE,OSOBA_SUB_PRACKAT_CODE) values ('IGOR','FERKO',to_date('30.05.14 10:02:33','DD.MM.RR HH24:MI:SS'),null,'MAN','PRAC');
Insert into TST_PRACVZTAH (OSOBA_TOP_CODE,OSOBA_SUB_CODE,VALID_FROM,VALID_TO,OSOBA_TOP_PRACKAT_CODE,OSOBA_SUB_PRACKAT_CODE) values ('IGOR','JOZKO',to_date('30.05.14 10:19:45','DD.MM.RR HH24:MI:SS'),null,'MAN','PRAC');
REM INSERTING into TST_TYPPRACVZTAH
SET DEFINE OFF;
Insert into TST_TYPPRACVZTAH (PRACKAT_TOP_CODE,PRACKAT_SUB_CODE) values ('CEO','MAN');
Insert into TST_TYPPRACVZTAH (PRACKAT_TOP_CODE,PRACKAT_SUB_CODE) values ('MAN','PRAC');
--------------------------------------------------------
--  Constraints for Table TST_OSOBA
--------------------------------------------------------

  ALTER TABLE "TST_OSOBA" ADD CONSTRAINT "TST_OSOBA_UK1" UNIQUE ("CODE", "PRACKAT_CODE") ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "TST_TYPPRACVZTAH" ADD CONSTRAINT "TST_TYPPRACVZTAH_PK" PRIMARY KEY ("PRACKAT_TOP_CODE", "PRACKAT_SUB_CODE") ENABLE;
/
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "TST_PRACVZTAH" ADD CONSTRAINT "TST_PRACVZTAH_TST_OSOBA_FK3" FOREIGN KEY ("OSOBA_TOP_CODE", "OSOBA_TOP_PRACKAT_CODE")
	  REFERENCES "TST_OSOBA" ("CODE", "PRACKAT_CODE") ENABLE;
  ALTER TABLE "TST_PRACVZTAH" ADD CONSTRAINT "TST_PRACVZTAH_TST_OSOBA_FK4" FOREIGN KEY ("OSOBA_SUB_CODE", "OSOBA_SUB_PRACKAT_CODE")
	  REFERENCES "TST_OSOBA" ("CODE", "PRACKAT_CODE") ENABLE;
  ALTER TABLE "TST_PRACVZTAH" ADD CONSTRAINT "TST_PRACVZTAH_TST_TYPPRAC_FK1" FOREIGN KEY ("OSOBA_TOP_PRACKAT_CODE", "OSOBA_SUB_PRACKAT_CODE")
	  REFERENCES "TST_TYPPRACVZTAH" ("PRACKAT_TOP_CODE", "PRACKAT_SUB_CODE") ENABLE;
/
--------------------------------------------------------
